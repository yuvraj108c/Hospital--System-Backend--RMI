...
public class client {
	...
	public static void main(String[] args) throws NotBoundException, SQLException, JSONException {
		try {
			Registry r = LocateRegistry.getRegistry("192.168.43.216", 1099);
			String result = "";
			...
			// result2 = checkup.updateChe ckup(27, "new diagnosis", "incomplete");
			...
			// result2 = specialTreatment.updateSpecialTreatment(37, "new treatment", 2,
			// "complete");
